...
g.test_bad_host = function()
    --local conn, err = pg.connect('postgresql://127.0.0.73', 2)
    --t.assert(err ~= nil)
...
g.test_types = function()
    ...
    t.assert_equals(rc[1](0,0), -32768)
    t.assert_equals(rc[1](0,1), 32767)
    t.assert_equals(rc[1](0,2), -2147483648, rc[1](0,2))
    t.assert_equals(rc[1](0,3), 2147483647, rc[1](0,3))
    t.assert_equals(rc[1](0,4), tonumber64('-9223372036854775808'))
    t.assert_equals(rc[1](0,5), tonumber64('9223372036854775807ULL'))
    t.assert_equals(rc[1](0,6), '1234.56789')
    t.assert_equals(rc[1](0,7), '1234.56789')

    t.assert_equals(rc[1](0,8), 10000.0, rc[1](0,8))
    t.assert_equals(rc[1](0,9), 2e5)

    -- default locale is dollars
    t.assert_equals(rc[1](0,10), '$52,093.89')
    t.assert_equals(type(rc[1](0,11)), 'cdata')
    t.assert_equals(rc[1](0,11), box.NULL)
    t.assert_equals(rc[1](0,12), 'Hello world')
    -- HEX string with \x escaping (not a binary)
    t.assert_equals(rc[1](0,13), '\\xdeadbeef', rc[1](0,13))
    t.assert_equals(rc[1](0,14), '1997-12-17 07:37:16', rc[1](0,14))
    t.assert_equals(rc[1](0,15), '01:00:00', rc[1](0,15))

    t.assert_equals(rc[1](0,16), true, rc[1](0,16))
    t.assert_equals(rc[1](0,17), false, rc[1](0,17))
end
